...
- **Reproduction:** Run `ConstellationDetection.ipynb` or `.venv/bin/python constellation.py --data Data --output outputs/q5/submission_v4.csv --calibration outputs/q5/calibration_v4.json`. The calibration procedure is unchanged; the notebook saves a versioned copy. V4 public/private scores have not been measured here, and no Kaggle upload is performed.
